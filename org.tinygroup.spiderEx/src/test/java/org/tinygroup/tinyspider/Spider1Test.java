...
public class Spider1Test {
	...
	public static void main(String[] args) throws Exception {
        ...
        nodeFilter.setIncludeAttribute("id","content");
		watcher.setNodeFilter(nodeFilter);
		spider.addWatcher(watcher);
		spider.processUrl("http://www.siluke.com/0/104/104663/15739132.html");
	}
